...
### v2.6.4 (2025-09-14) ⭐ 最新版本 - 数据库优化已部署
- ⚡ **查询性能革命性提升**: 股票列表查询 1ms，概念排行 2ms，提升50-200倍
- 🏗️ **全新数据库架构**: 6张优化表结构，分区表设计，预计算排名和概念数量
- 💾 **智能缓存系统**: 内存表缓存当日热数据，5个高性能视图，覆盖索引优化
- 🚀 **一键部署工具**: Shell+Python双重部署脚本，自动化数据迁移，零停机切换
- 📊 **性能监控**: 查询性能自动记录，SQL执行计划优化，可视化性能报告
- 🔧 **生产就绪**: 数据备份、回滚机制、环境配置管理，企业级稳定性保障
- 🎯 **API增强**: 优化开关控制，双写模式，性能对比测试API

### v2.6.3 (2025-09-13)
- 🔄 **个股分析模式调整**: 恢复以股票列表为主的分析模式，提供更直观的股票筛选体验
- 📊 **股票驱动分析**: 主页面显示股票排名，操作列提供"查看概念"功能
- 🗂️ **导航结构优化**: 移除冗余的"股票查询"页面，简化系统导航结构
- 📚 **文档结构重组**: 完成项目文档和脚本的标准化分类管理
- 🎯 **用户体验提升**: 基于TXT导入数据的股票分析，支持搜索、排序、概念深度查看
